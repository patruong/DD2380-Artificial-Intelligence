...
///////////////////////////////////////////////////////////////////////
int minimax_val(const GameState &pState, uint8_t Player, int count){ //TODO:: skicka med depth parameters som du ++ varje iteration på rad 154 och 164
    count++; 
    std::vector<GameState> lNextStates;
    pState.findPossibleMoves(lNextStates); //THIS IS MU
    
    //UTILITY FUNCTION
    if(pState.isEOG() || depth > något value ){ //TODO :: välj depth 
        return utilityValue(pState); // TODO:: Gör enkel utilityfunction precis som beskrivet i labbassignment under Grade E, D
    }
